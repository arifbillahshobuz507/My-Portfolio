<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
    <div>
      ...
      <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="../backend/assets/images/logo/logo-icon.png" alt=""></a></div>
      <nav class="sidebar-main">
        <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            <li class="back-btn"><a href="index.html"><img class="img-fluid" src="../backend/assets/images/logo/logo-icon.png" alt=""></a>
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="landing-page.html">
                <svg class="stroke-icon">
                  <use href="../backend/assets/svg/icon-sprite.svg#stroke-landing-page"></use>
                </svg>
                <svg class="fill-icon">
                  <use href="../backend/assets/svg/icon-sprite.svg#fill-landing-page"></use>
